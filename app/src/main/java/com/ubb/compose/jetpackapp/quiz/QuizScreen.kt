...
import com.ubb.compose.jetpackapp.theme.progressIndicatorBackground
    ...
    Surface(modifier = Modifier.supportWideScreen()) {
        Scaffold(
            content = { innerPadding ->
                ...
                QuizResult(result = result, modifier = modifier)
            },
            bottomBar = {
                OutlinedButton(
...
@Composable
private fun QuizResult(result: QuizState.Result, modifier: Modifier = Modifier) {
    LazyColumn(modifier = modifier.fillMaxSize()) {
        item {
            Spacer(modifier = Modifier.height(44.dp))
            Text(
                text = result.quizResult.library,
            ...
            Text(
                text = stringResource(
                    ...
                    result.quizResult.library
                ),
                style = MaterialTheme.typography.subtitle1,
                modifier = Modifier.padding(20.dp)
            )
            Text(
                text = stringResource(result.quizResult.description),
